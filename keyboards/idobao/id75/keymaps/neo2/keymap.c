 ...
 */
 ...
 [_L1] = LAYOUT_ortho_5x15( /* QWERTY */
    ...
    MO(_FN), KC_TAB,  KC_X,    KC_V,    KC_L,    KC_C,    KC_W,    KC_K,    KC_H,    KC_G,    KC_F,    KC_Q,    UC(L'ß'),KC_RBRC, DF(_QW),
 ...
 */
 ...
 [_L2] = LAYOUT_ortho_5x15( /* QWERTY */
    ...
    MO(_FN), KC_TAB,  KC_X,    KC_V,    KC_L,    KC_C,    KC_W,    KC_K,    KC_H,    KC_G,    KC_F,    KC_Q,    UC(L'ẞ'),NU(0303),DF(_QW),
    KC_ESC,  NE_M3,   KC_U,    KC_I,    KC_A,    KC_E,    KC_O,    KC_S,    KC_N,    KC_R,    KC_T,    KC_D,    KC_Y, NE_M3,   KC_ENT,
 ...
 */
 ...
 [_L3] = LAYOUT_ortho_5x15( /* QWERTY */
    ...
    MO(_FN), KC_RALT, UC(L'…'),KC_UNDS, KC_LBRC, KC_RBRC, KC_CIRC, KC_EXLM, KC_LT,   KC_GT,   KC_EQL,  KC_AMPR, UC(L'ſ'),NU(0338),DF(_QW),
 ...
 */
 ...
 [_L5] = LAYOUT_ortho_5x15( /* QWERTY */
    ...
    MO(_FN), KC_TAB,  UC(L'ξ'),KC_NO,   UC(L'λ'),UC(L'χ'),UC(L'ω'),UC(L'κ'),UC(L'ψ'),UC(L'γ'),UC(L'φ'),UC(L'ϕ'),UC(L'ς'),NU(0313),DF(_QW),
 ...
 */
 ...
 [_L6] = LAYOUT_ortho_5x15( /* QWERTY */
    ...
    MO(_FN), KC_TAB,  UC(L'Ξ'),UC(L'√'),UC(L'Λ'),UC(L'ℂ'),UC(L'Ω'),UC(L'×'),UC(L'Ψ'),UC(L'Γ'),UC(L'Φ'),UC(L'ℚ'),UC(L'∘'),NU(0306),DF(_QW),
